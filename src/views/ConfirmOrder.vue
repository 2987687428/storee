...
<template>
  <div class="confirmOrder">
    ...
    <div class="content">
     ...
     <!-- 快递选择-->
      <div class="section-shipment">
        <p class="title">快递选择</p>
        <form>
        <p class="shipment2">
        <input type="radio" name="kd" id="yunda" value="韵达快递" v-model="kd1" >韵达快递
        <input type="radio" name="kd" id="ems" value="EMS快递" v-model="kd1" >EMS快递
        <input type="radio" name="kd" id="shunf" value="顺丰快递" v-model="kd1" >顺丰快递
        <input type="radio" name="kd" id="shunf" value="圆通快递" v-model="kd1" >圆通快递
        </p>
        </form>
      </div>
      <!-- 快递选择END -->
      ...
      <div class="section-count">
        <div class="money-box">
          <ul>
            ...
            <li>
              <span class="title">快递选择：</span>
              <span class="value">{{kd1}}</span>
            </li>
            <li>
      ...
      address: [
        {
          ...
          name: "酆都",
          phone: "13742478823",
          address: "江苏省 无锡市 惠山区 天一街道 阳光100"
         }
      ]
    };
  },
...
.confirmOrder .content .section-shipment .shipment2 {
  line-height: 38px;
  font-size: 14px;
  color: #000000;
}
/* 配送方式（include快递）CSS END */
